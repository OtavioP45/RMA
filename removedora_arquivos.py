...
if os.path.isfile(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'localizacao_produtos_indice.csv')): os.remove(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'localizacao_produtos_indice.csv'))
