...
"
  'Spawn' 'waitForSimulation; rosservice call /mrs_drone_spawner/spawn "1 --pos -1 -2 0.05 0 $UAV_TYPE --enable-rplidar --enable-rangefinder --enable-ground-truth --enable-bluefox-camera --enable-realsense-front"
'
